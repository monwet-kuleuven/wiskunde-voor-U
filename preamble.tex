...
\newcommand{\limx}{\lim_{x \rightarrow 0}}    % g  voor Generic ...
...
\newcommand{\limxc}{\limxg{c}}     % was handig in de module over limieten ...
\newcommand{\llimxc}{\llimxg{c}}
\newcommand{\rlimxc}{\rlimxg{c}}

\newcommand{\important}[1]{\text{\colorbox{lightgray}{$#1$}}}
