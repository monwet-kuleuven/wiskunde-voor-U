...
%	\end{alignat*}
	...
	&\limxmi x^2 - \limxmi e^x  &=&& (+\infty)1-0  &=  +\infty &=&& \limxmi (x^2-e^x)
	\end{align*}
	
	Het lijkt wat verdacht dat $(+\infty) - (+\infty) = -\infty$, wat nodig is om $\limxi (x^2-e^x)  \overset{?}{=} \limxi x^2  - \limxi e^x$ te doen kloppen.  
