...
%		extra y ticks={0},
		...
		\node[anchor=west, color=red, font=\small] at  (axis cs: 0.2,4.4) {$1/x\rightarrow +\infty$};

		\node[anchor=west, color=red, font=\small] at  (axis cs: -6,0.2) {$-\infty\leftarrow x$};
		\node[anchor=west, color=red, font=\small] at  (axis cs: -6,-0.8) {$1/x\rightarrow 0$};

		\node[anchor=east, color=red, font=\small] at  (axis cs: 6,-0.4) {$x\rightarrow +\infty$};
		\node[anchor=east, color=red, font=\small] at  (axis cs: 6,0.8) {$1/x\rightarrow 0$};
