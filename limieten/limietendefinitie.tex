\documentclass[noinstructornotes,numbers]{ximera}
...
\todo {nadenken over outcomes (formulering/gebruik/...)}
\todo{nadenken over 'jij' vorm of 'we' vorm in dit soort teksten !!!}
...
\todo{layout/functionaliteit 'uitwijding' (dus: expandable aanpassen/vervangen; voorlopig adhoc tcolorbox) }
\todo{Uitzoeken: hoe werkt expandable precies}
\todo{limieten: goed voorbeeldje vinden 'interesse net op de rand'}

\begin{uitwijding}[Wat en waarom van limieten] \ 
