...
\begin{example} (Limieten van $\frac{\sin x}{x}$ ( of dus $\frac 1x \sin x$))
...
\begin{example}  (Limiet $x\sin\frac 1x$ )
	
	TODO   (Uitbreiding?)
\end{example}

\begin{example}  (Limiet $\sin\frac 1x$ )
