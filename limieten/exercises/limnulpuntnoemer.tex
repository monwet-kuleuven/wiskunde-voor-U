...
\begin{exercise} \ 
	...
	% todo: limiet van sin(1/x): bestaat ook niet
		...
		\begin{question} 
			...
			\end{feedback}	
			\begin{feedback}[1>0]Mmm, wat gebeurt er met $1/(x-1)^2$ als $x$ klein wordt? We zoeken de limiet in $0$!
			\end{feedback}
		\end{question}
		\begin{question} 
			...
			\end{feedback}	
			\begin{feedback}[1>0]Mmm, wat gebeurt er met $1/(x-1)^2$ voor $x$ dicht bij $1$? We zoeken de limiet in $1$!
			\end{feedback}
