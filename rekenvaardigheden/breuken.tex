...
%	\begin{enumerate}
%		\item %Breuk splitsen:\ \
%			$\frac{120+74}{2}\underset{(\text{breuk splitsen})}{=}\frac{120}{2}+\frac{74}{2}=60+37=97$ 
%		\\ (maar natuurlijk ook $\frac{120+74}{2}=\frac{194}{2}=97$)
%		\item %Breuken optellen:\ \ 
%			$\frac{1}{8}+\frac{5}{6}\underset{(\text{gelijke noemer})}{=}\frac{1 \cdot 6+5 \cdot 8}{48}=\frac{46}{48} =\frac{23}{24}$
%		\item %Breuk vereenvoudigen:\ \ 
%			$\frac{125}{50}\underset{(\text{ontbinden})}{=}\frac{25 \cdot 5}{25 \cdot 2}\underset{(\text{vereenvoudigen})}{=}\frac{5}{2}$
%		\item %Rekenen met meerdere breukstrepen:\ \
%			$\frac{\frac{80}{2}}{10}\underset{(\text{dubbele breukstreep})}{=}\frac{80}{2\cdot10}=\frac{80}{20}=4$ 
%		\\ (maar natuurlijk ook $\frac{\frac{80}{2}}{10}=\frac{40}{10} = 4$)
%	\end{enumerate}
%\end{example}
